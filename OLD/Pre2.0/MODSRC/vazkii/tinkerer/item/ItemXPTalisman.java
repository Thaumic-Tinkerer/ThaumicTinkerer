 ...
 *
 * File Created @ [1 May 2013, 18:48:38 (GMT)]
 */
...
public class ItemXPTalisman extends ItemMod {
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
		...
		if(getXP(par1ItemStack) >= LibFeatures.XP_TALISMAN_MAX_XP)
			par3List.add(EnumChatFormatting.RED + "Full");
		else if(par1ItemStack.getItemDamage() == 0)
			par3List.add(EnumChatFormatting.RED + "Not Absorbing");
		else par3List.add(EnumChatFormatting.GREEN + "Absorbing");
	}
