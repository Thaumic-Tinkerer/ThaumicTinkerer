...
public interface IWailaDataProvider{
	 ...
	 */
	ItemStack    getWailaStack(mcp.mobius.waila.api.IWailaDataAccessor accessor, mcp.mobius.waila.api.IWailaConfigHandler config);
	 ...
	 */
	List<String> getWailaHead(ItemStack itemStack, List<String> currenttip, mcp.mobius.waila.api.IWailaDataAccessor accessor, mcp.mobius.waila.api.IWailaConfigHandler config);
	 ...
	 * @return Modified input currenttip
	 */	
	List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, mcp.mobius.waila.api.IWailaDataAccessor accessor, mcp.mobius.waila.api.IWailaConfigHandler config);
	 ...
	 * @return Modified input currenttip
	 */	
	List<String> getWailaTail(ItemStack itemStack, List<String> currenttip, mcp.mobius.waila.api.IWailaDataAccessor accessor, IWailaConfigHandler config);
