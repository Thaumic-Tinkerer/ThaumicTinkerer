...
public class SubTileEntity {
	...
	/**
	 * @see vazkii.botania.api.wand.IWandBindable#canSelect(net.minecraft.entity.player.EntityPlayer, net.minecraft.item.ItemStack, int, int, int, int)
	 */
	...
	/**
	 * @see vazkii.botania.api.wand.IWandBindable#bindTo(net.minecraft.entity.player.EntityPlayer, net.minecraft.item.ItemStack, int, int, int, int)
	 */
