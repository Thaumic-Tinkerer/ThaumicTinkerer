...
public class AspectCropLootManager {
  ...
  public static void populateLootMap() {
    ...
    addAspectLoot(
        ...
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
                          ItemInfusedGrain.class),
                      1, ItemInfusedGrain.getMetaForAspect(Aspect.FIRE)));
    addAspectLoot(
        Aspect.EARTH,
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
                          ItemInfusedGrain.class),
                      1, ItemInfusedGrain.getMetaForAspect(Aspect.EARTH)));
    addAspectLoot(
        Aspect.WATER,
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
                          ItemInfusedGrain.class),
                      1, ItemInfusedGrain.getMetaForAspect(Aspect.WATER)));
    ...
    for (Aspect tag : Aspect.aspects.values()) {
      ...
      ((ItemWispEssence)ConfigItems.itemWispEssence)
          .setAspects(i, new AspectList().add(tag, 2));
    ...
    for (Enchantment enchant : Enchantment.enchantmentsBookList) {
      addAspectLoot(Aspect.MIND,
                    Items.enchanted_book.getEnchantedItemStack(
                        new EnchantmentData(enchant, 1)),
                    1);
    }

    addAspectLoot(Aspect.FLESH, new ItemStack(ConfigItems.itemResource, 16, 5),
                  4);
    addAspectLoot(Aspect.FLESH, new ItemStack(ConfigItems.itemResource, 16, 5),
                  1);
    ...
    addAspectLoot(Aspect.CRAFT,
                  new ItemStack(ThaumicTinkerer.registry.getFirstBlockFromClass(
                                    BlockDarkQuartz.class),
                                32));
    addAspectLoot(Aspect.CRAFT,
                  new ItemStack(ConfigBlocks.blockStoneDevice, 16));
    ...
    addAspectLoot(Aspect.TRAVEL,
                  new ItemStack(ConfigBlocks.blockCosmeticSolid, 8, 7));
    ...
    addAspectLoot(Aspect.LIGHT,
                  new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
                      ItemBrightNitor.class)));
    ...
    addAspectLoot(Aspect.EXCHANGE,
                  new ItemStack(ConfigBlocks.blockCustomOre, 4));
    ...
    addAspectLoot(Aspect.POISON,
                  new ItemStack(ConfigItems.itemResource, 16, 3));
