...
public class ItemIchorPickAdv extends ItemIchorPick implements IAdvancedTool {
  ...
  public IIcon getIconFromDamage(int par1) {
    return par1 >= specialIcons.length ? super.getIconFromDamage(par1)
                                       : specialIcons[par1];
  }
  ...
  public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World,
    ...
    if (par3EntityPlayer.isSneaking()) {
      ...
      ToolModeHUDHandler.setTooltip(
          ToolHandler.getToolModeStr(this, par1ItemStack));
    }
  ...
  public float func_150893_a(ItemStack p_150893_1_, Block p_150893_2_) {
    return (p_150893_2_ == Blocks.bedrock)
        ? Float.MAX_VALUE
  ...
  public float getDigSpeed(ItemStack stack, Block block, int meta) {
    return (block == Blocks.bedrock) ? Float.MAX_VALUE
  ...
  public boolean onBlockStartBreak(ItemStack stack, int x, int y, int z,
    ...
    MovingObjectPosition block =
        ToolHandler.raytraceFromEntity(world, player, true, 4.5);
    if (block == null)
      return false;
    ...
    case 1: {
      ...
      ToolHandler.removeBlocksInIteration(
          player, world, x, y, z, doX ? -2 : 0, doY ? -1 : 0, doZ ? -2 : 0,
          doX ? 3 : 1, doY ? 4 : 1, doZ ? 3 : 1, null,
          ToolHandler.materialsPick, silk, fortune);
    ...
    case 2: {
      ...
      ToolHandler.removeBlocksInIteration(
          player, world, x, y, z, xo >= 0 ? 0 : -10, yo >= 0 ? 0 : -10,
          zo >= 0 ? 0 : -10, xo > 0 ? 10 : 1, yo > 0 ? 10 : 1, zo > 0 ? 10 : 1,
          null, ToolHandler.materialsPick, silk, fortune);
      break;
    }
    }
    if (ConfigHandler.bedrockDimensionID != 0 && blk == Blocks.bedrock &&
  ...
  public ThaumicTinkererRecipe getRecipeItem() {
    return new ThaumicTinkererInfusionRecipe(
        LibResearch.KEY_ICHOR_PICK_GEM, new ItemStack(this), 15,
        new AspectList()
            .add(Aspect.FIRE, 50)
            .add(Aspect.MINE, 64)
            .add(Aspect.METAL, 32)
        ...
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
            ItemIchorPick.class)),
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
                          ItemKamiResource.class),
                      1, 2),
        new ItemStack(ThaumicTinkerer.registry.getFirstItemFromClass(
            ItemKamiResource.class)),
        new ItemStack(ConfigItems.itemPickElemental),
        new ItemStack(ConfigItems.itemFocusExcavation),
        new ItemStack(Blocks.tnt), new ItemStack(ConfigItems.itemNugget, 1, 21),
