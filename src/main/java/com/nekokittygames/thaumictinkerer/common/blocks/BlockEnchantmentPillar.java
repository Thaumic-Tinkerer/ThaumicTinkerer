...
public class BlockEnchantmentPillar
  ...
  public static final PropertyInteger Direction =
      PropertyInteger.create("direction", 0, 7);
  ...
  private BlockPos IsEnchanterPos(World world, BlockPos pos) {
    if (world.getBlockState(pos).getBlock() == ModBlocks.osmotic_enchanter)
      return pos;
    if (world.getBlockState(pos.down(1)).getBlock() ==
        ModBlocks.osmotic_enchanter)
      return pos.down(1);
    return null;
  }
  @Override
