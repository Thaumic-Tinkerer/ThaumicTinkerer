...
public class BlockRepairer extends TTTileEntity<TileEntityRepairer> {
    ...
    public BlockRepairer() {
        ...
        setDefaultState(this.getBlockState().getBaseState().withProperty(ACTIVE, false).withProperty(FACING, EnumFacing.NORTH));
    }
    ...
    public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
        ...
        return !(Boolean) state.getValue(ACTIVE) && super.rotateBlock(world, pos, axis);
    }

    @Override
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return this.getDefaultState().withProperty(FACING, EnumFacing.getDirectionFromEntityLiving(pos, placer)).withProperty(ACTIVE, false);
    }
