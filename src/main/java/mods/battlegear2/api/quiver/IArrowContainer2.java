...
public interface IArrowContainer2 {
     ...
     * @return True to receive {@link #addArrows(net.minecraft.item.ItemStack, net.minecraft.item.ItemStack)}
     */
    public boolean isCraftableWithArrows(ItemStack contaner, ItemStack arrowStack);

    /**
     * Crafts the item with the items from {@link #isCraftableWithArrows(net.minecraft.item.ItemStack, net.minecraft.item.ItemStack)}
     * @param container The {@link #ItemStack} representing this item
