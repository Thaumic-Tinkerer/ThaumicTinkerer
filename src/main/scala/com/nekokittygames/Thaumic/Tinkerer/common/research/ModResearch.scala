...
object ModResearch {
  ...
  def registerResearch() = {
    ...
    research=new TTResearchItem(LibResearch.KEY_DARK_QUARTZ,new AspectList(),-2,2,0,new ItemStack(ItemDarkQuartz),new ResearchPage("0"),recipePage(LibResearch.KEY_DARK_QUARTZ+0),recipePage(LibResearch.KEY_DARK_QUARTZ_BLOCKS+0),recipePage(LibResearch.KEY_DARK_QUARTZ_BLOCKS+1)).setSecondary().registerResearchItem().asInstanceOf[TTResearchItem]
