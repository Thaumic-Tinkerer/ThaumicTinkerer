...
object LibMisc {
    ...
    final val DEPENDENCIES = "required-after:Forge;before:MagicBees;before:advthaum;after:IC2;after:ThaumicTinkererKami;after:Waila;after:ForgeMultipart;after:ComputerCraft"
